...
const view = {
    ...
    demo: path.join(__dirname, '../../', 'public/view/demo.html'),
};
...
if (turnEnabled == 'true') {
    iceServers.push(
        ...
        },
        {
            ...
            urls: 'turn:99.72.32.144:5349',
            username: admin,
            credential: Cyber2003,
        },
    );
} else {
    ...
    iceServers.push(
      ...
      /*  {
        ...
        },
        {
            ...
            // username: 'openrelayproject',
            // credential: 'openrelayproject',
            urls: 'turn:99.72.32.144:443:443?transport=tcp',
            username: admin,
            credential: Cyber2003,
        },*/
    );
