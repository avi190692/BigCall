...
//   } else {
    log("chrome1 local stream");
    localVideo.srcObject = stream;// URL.createObjectURL(stream);
  //}
...
//    remoteVideo.src = window.URL.createObjectURL(event.stream);
    var binaryData = [];
    binaryData.push(event.stream);
    localVideo.src = window.URL.createObjectURL(new Blob(binaryData, {type: "video/mp4"}));
  } else {
    // Firefox
